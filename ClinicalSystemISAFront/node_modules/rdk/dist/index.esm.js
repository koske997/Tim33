import React, { Component, PureComponent, createContext, Fragment } from 'react';
...
class ExitListener extends Component {
    constructor() {
        super(...arguments);
        this.node = null;
...
class OverlayPortal extends Component {
    ...
    render() {
        ...
        return (React.createElement(Portal, { onMount: onMount, onUnmount: onUnmount }, render({ overlayIndex, portalIndex, backdropIndex })));
    }
}
...
class Backdrop extends PureComponent {
    render() {
        ...
        return (React.createElement(AnimatePresence, null, visible && (React.createElement(motion.div, { className: classNames(css$1.backdrop, className), initial: { opacity: 0 }, animate: { opacity: (0.8 - (portalIndex / 10)) }, exit: { opacity: 0 }, onClick: onClick, style: { zIndex } }))));
    }
}
...
class GlobalOverlay extends Component {
    ...
    render() {
        ...
        return (React.createElement(OverlayContext.Provider, { value: {
                close: bind(this.close, this)
            } },
            React.createElement(AnimatePresence, null, open && (React.createElement(Fragment, null,
                React.createElement(OverlayPortal, null, ({ overlayIndex, backdropIndex, portalIndex }) => (React.createElement(Fragment, null,
                    hasBackdrop && (React.createElement(Backdrop, { zIndex: backdropIndex, portalIndex: portalIndex, visible: open, onClick: bind(this.onBackdropClick, this), className: classNames(backdropClassName) })),
                    React.createElement(ExitListener, { onEscape: closeOnEscape ? bind(this.close, this) : null }, renderFn({ overlayIndex }))))),
...
class OverlayTrigger extends Component {
    ...
    render() {
        ...
        return (React.createElement("span", { tabIndex: tabIndex, ref: ref => (this.element = ref), onMouseEnter: bind(this.onMouseEnter, this), onMouseLeave: bind(this.onMouseLeave, this), onFocus: bind(this.onFocus, this), onBlur: bind(this.onBlur, this), onClick: bind(this.onClick, this), className: classNames(className) }, children));
    }
}
...
class Position extends Component {
    ...
    render() {
        ...
        return (React.createElement("span", { ref: elm => this.createPopper(elm), className: classNames(className, container), style: style }, children));
    }
}
...
class ConnectedOverlay extends React.Component {
    ...
    renderContent() {
        ...
        const reference = this.getReference();
        return (React.createElement(Position, { style: { zIndex }, reference: reference, placement: placement, modifiers: modifiers, followCursor: followCursor, ref: ref => (this.positionRef = ref) },
            React.createElement(ExitListener, { onClickOutside: bind(this.onClickOutside, this), onEscape: bind(this.onEscape, this) }, content())));
    }
    render() {
        const { children, trigger, visible, onActivate, onDeactivate, appendToBody } = this.props;
        return (React.createElement(Fragment, null,
            children && trigger && onActivate && onDeactivate && (React.createElement(OverlayTrigger, { trigger: trigger, onActivate: onActivate, onDeactivate: onDeactivate, ref: ref => (this.triggerRef = ref) }, children)),
            children && !trigger && children,
            React.createElement(AnimatePresence, null, visible && (React.createElement(Fragment, null,
                appendToBody && (React.createElement(Portal, null, this.renderContent())),
...
export { Backdrop, ConnectedOverlay, ExitListener, GlobalOverlay, OverlayContext, OverlayPortal, OverlayTrigger, Portal, Position };

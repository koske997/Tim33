...
function applyExitProps(props, _a) {
    ...
    if (isExiting) {
        heyListen.invariant(!!props.exit, "No exit animation defined.");
        ...
        return tslib_1.__assign({}, props, { initial: initial });
    }
    return props;
}
...
var createMotionComponent = function (_a) {
    ...
    function MotionComponent(props, externalRef) {
        ...
        var _a = React.useContext(MotionContext), exitProps = _a.exitProps, parentContext = tslib_1.__rest(_a, ["exitProps"]);
        if (exitProps) {
        ...
        loadFunctionalityComponents: function (ref, values, props, controls, inherit) {
            ...
            for (var i = 0; i < numFunctionalityComponents; i++) {
                ...
                if (shouldRender(props)) {
                    activeComponents.push(React.createElement(Component_1, tslib_1.__assign({ key: key }, props, { values: values, controls: controls, innerRef: ref })));
                }
            }
 ...
 * @public
 */
var motion = tslib_1.__assign({ custom: function (Component) {
...
var PresenceChild = function (_a) {
    ...
    context = exitProps ? tslib_1.__assign({}, context, { exitProps: exitProps }) : tslib_1.__assign({}, context);

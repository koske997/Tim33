(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('classnames'), require('ellipsize'), require('d3-array'), require('calculate-size'), require('human-format'), require('d3-shape'), require('transformation-matrix'), require('d3-scale'), require('memoize-bind'), require('react-sizeme'), require('big-integer'), require('chroma-js'), require('rdk'), require('framer-motion'), require('is-equal'), require('memoize-one'), require('d3-interpolate'), require('d3-geo'), require('d3-sankey'), require('react-countup')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'classnames', 'ellipsize', 'd3-array', 'calculate-size', 'human-format', 'd3-shape', 'transformation-matrix', 'd3-scale', 'memoize-bind', 'react-sizeme', 'big-integer', 'chroma-js', 'rdk', 'framer-motion', 'is-equal', 'memoize-one', 'd3-interpolate', 'd3-geo', 'd3-sankey', 'react-countup'], factory) :
  (global = global || self, factory(global.reaviz = {}, global.React, global.classNames, global.ellipsize, global.d3Array, global.calculateSize, global.humanFormat, global.d3Shape, global.transformationMatrix, global.d3Scale, global.bind, global.reactSizeme, global.bigInt, global.chroma, global.rdk, global.framerMotion, global.isEqual, global.memoize, global.d3Interpolate, global.d3Geo, global.d3Sankey, global.CountUp));
}(this, (function (exports, React, classNames, ellipsize, d3Array, calculateSize, humanFormat, d3Shape, transformationMatrix, d3Scale, bind, reactSizeme, bigInt, chroma, rdk, framerMotion, isEqual, memoize, d3Interpolate, d3Geo, d3Sankey, CountUp) { 'use strict';
  ...
  ***************************************************************************** */
  ...
  const ResizeInner = props => React__default.createElement(React.Fragment, null, props.children);
  class ResizeContainer extends React.PureComponent {
      constructor(props) {
          super(props);
          if (this.shouldAutosize()) {
              this.SizeMe = reactSizeme.withSize({
      ...
      render() {
          ...
          return (React__default.createElement(React.Fragment, null,
              shouldAutosize && (React__default.createElement(SizeMe, { onSize: onSize },
                  React__default.createElement("div", { style: { height: '100%', width: '100%' } }, children))),
  ...
  class ChartContainer extends React.Component {
      ...
      render() {
          ...
          return (React__default.createElement(ResizeContainer, { onSize: bind(this.onResize, this), height: this.props.height, width: this.props.width }, height && width && (React__default.createElement("svg", { width: width, height: height, className: className, style: style },
  ...
  const Tooltip = (_a) => {
      ...
      return (React__default.createElement(rdk.ConnectedOverlay, Object.assign({}, rest, { placement: placement, trigger: trigger, followCursor: followCursor, visible: internalVisible, content: () => {
              const contentChildren = typeof content === 'function' ? content() : content;
              if (!contentChildren) {
                  return null;
              }
              return (React__default.createElement(framerMotion.motion.div, { className: classNames(css$j.tooltip, className), initial: { opacity: 0, scale: 0.3 }, animate: { opacity: 1, scale: 1 }, exit: { opacity: 0, scale: 0.3 } }, contentChildren));
          }, onActivate: () => {
              if (!internalVisible) {
                  deactivateAll();
                  clearTimeout(timeout.current);
  ...
  const TooltipTemplate = ({ value, color, className }) => {
      ...
      const renderValues = (data, index) => {
          ...
          return (React__default.createElement("span", { className: css$l.subValue },
              React__default.createElement("span", { className: css$l.subValueColor, style: { backgroundColor: fill } }),
              React__default.createElement("span", { className: css$l.subValueName },
      ...
      return (React__default.createElement("div", { className: className },
          React__default.createElement("div", { className: css$l.label }, formatValue(value.x)),
          React__default.createElement("div", { className: css$l.value },
  ...
  const ChartTooltip = (_a) => {
      ...
      return (React__default.createElement(Tooltip, Object.assign({}, rest, { content: () => {
              if (!value && !data) {
                  return null;
              }
  ...
  class ScatterPoint extends React.Component {
      constructor() {
          super(...arguments);
      ...
      renderCircle() {
          ...
          return (React__default.createElement(framerMotion.motion.circle, { key: `symbol-${id}-${data.id}`, className: extras.className, style: Object.assign(Object.assign({}, extras.style), { cursor }), initial: initial, animate: {
                  cx: enter.x,
                  cy: enter.y,
                  opacity: 1,
                  fill,
      ...
      renderSymbol() {
          ...
          return (React__default.createElement(framerMotion.motion.g, Object.assign({ key: `symbol-${id}-${data.id}` }, extras, { initial: initial, animate: {
                  translateX: enter.x,
                  translateY: enter.y,
                  opacity: 1
      ...
      render() {
          ...
          return (React__default.createElement(React.Fragment, null,
              React__default.createElement("g", { ref: this.rect, onMouseEnter: bind(this.onMouseEnter, this), onMouseLeave: bind(this.onMouseLeave, this), onClick: bind(this.onClick, this), className: classNames({
                      [css$n.inactive]: !this.props.active
                  }) },
                  symbol && this.renderSymbol(),
                  !symbol && this.renderCircle()),
              tooltip && !tooltip.props.disabled && (React__default.createElement(CloneElement, { element: tooltip, visible: active, reference: this.rect, value: data }))));
      }
  }
  ...
  class ScatterSeries extends React.Component {
      ...
      render() {
          ...
          return (React__default.createElement(React.Fragment, null,
              ...
              React__default.createElement("g", { clipPath: `url(#${id}-path)` }, data.map((data, index) => this.renderPoint(data, index)))));
      }
  }
  ...
  class ScatterPlot extends React.Component {
      ...
      render() {
          ...
          return (React__default.createElement(ChartContainer, { id: id, width: width, height: height, margins: margins, xAxisVisible: isAxisVisible(xAxis.props), yAxisVisible: isAxisVisible(yAxis.props), className: classNames(css$p.scatterPlot, className) }, props => this.renderChart(props)));
      }
  }
  ...
  class PointSeries extends React.Component {
      ...
      render() {
          ...
          return (React__default.createElement(ScatterSeries, { height: height, width: width, id: id, animated: animated, data: data, xScale: xScale, yScale: yScale, point: React__default.createElement(CloneElement, { element: point, color: color, className: css$r.point, size: 4, tooltip: null, visible: this.isVisible.bind(this) }) }));
      }
  }
  ...
  class AreaChart extends React.Component {
      ...
      render() {
          ...
          return (React__default.createElement(ChartContainer, { id: id, width: width, height: height, margins: margins, xAxisVisible: isAxisVisible(xAxis.props), yAxisVisible: isAxisVisible(yAxis.props), className: classNames(css$t.areaChart, className, series.type) }, props => this.renderChart(props)));
      }
  }
  ...
  class Bar extends React.Component {
      ...
      renderGuideBar() {
          ...
          return (React__default.createElement(CloneElement, Object.assign({ element: guide }, coords, { x: coords.x, width: coords.width, active: active })));
      }
      render() {
  ...
  class RangeLines extends React.Component {
      ...
      render() {
          ...
          return (React__default.createElement(framerMotion.motion.rect, { pointerEvents: "none", fill: color, width: width, height: height, initial: exitProps, animate: enterProps, exit: exitProps, transition: Object.assign(Object.assign({}, DEFAULT_TRANSITION), { delay }) }));
      }
  }
  ...
  const GuideBar = (_a) => {
      ...
      return (React__default.createElement(framerMotion.motion.rect, Object.assign({}, rest, { fill: fill, pointerEvents: "none", initial: "hidden", animate: active ? 'visible' : 'hidden', variants: {
              hidden: { opacity: 0 },
              visible: { opacity }
          } })));
  };
  ...
  class BarChart extends React.Component {
      ...
      render() {
          ...
          return (React__default.createElement(ChartContainer, { id: id, width: width, height: height, margins: margins, xAxisVisible: isAxisVisible(xAxis.props), yAxisVisible: isAxisVisible(yAxis.props), className: classNames(css$x.barChart, className, css$x[series.props.type]) }, props => this.renderChart(props)));
      }
  }
  ...
  class HiveNode extends React.Component {
      render() {
          ...
          return (React__default.createElement("circle", { className: classNames(css$z.node, {
  ...
  class HiveAxis extends React.Component {
      render() {
          ...
          return (React__default.createElement(React.Fragment, null,
              React__default.createElement("line", { className: css$B.axis, style: { stroke: color(index) }, transform: `rotate(${getDegrees(angle(index))})`, x1: axisStart, x2: axisEnd }),
              React__default.createElement("line", { className: css$B.axis, style: { stroke: color(index) }, transform: `rotate(${getDegrees(angle(index)) + 90})`, x1: -axisLength / 20, x2: axisLength / 20, y1: -axisEnd, y2: -axisEnd }),
              React__default.createElement("line", { className: css$B.axis, style: { stroke: color(index) }, transform: `rotate(${getDegrees(angle(index)) + 90})`, x1: -axisStart / 3, x2: 0, y1: axisStart * -0.8, y2: axisStart * -1 }),
              React__default.createElement("line", { className: css$B.axis, style: { stroke: color(index) }, transform: `rotate(${getDegrees(angle(index)) + 90})`, x1: 0, x2: axisStart / 3, y1: -axisStart, y2: axisStart * -0.8 })));
      }
  }
  ...
  class HiveLink extends React.Component {
      ...
      render() {
          ...
          return (React__default.createElement("path", { className: classNames(css$D.link, {
  ...
  class HiveLabel extends React.Component {
      render() {
          ...
          return (React__default.createElement("text", { dy: translate(transform, outerRadius, label.padding), className: css$F.label, strokeWidth: "0.01", textAnchor: "middle", transform: `rotate(${transform})` }, text));
      }
  }
  ...
  class HiveTooltip extends React.Component {
      render() {
          ...
          return (React__default.createElement("div", null,
              React__default.createElement("div", { className: css$H.label },
                  label,
                  " - ",
                  formatValue(value)),
              React__default.createElement("div", { className: css$H.value },
                  formatValue(count),
                  " Total")));
      }
  }
  ...
  class HivePlot extends React.Component {
      ...
      renderTooltip() {
          ...
          return (React__default.createElement(React.Fragment, null, !disabled && show && (React__default.createElement(Tooltip, { visible: !!active, reference: tooltipReference, placement: placement, content: () => formatter(axis, nodes, link, node) ||
      ...
      render() {
          ...
          return (React__default.createElement(ResizeContainer, { onSize: bind(this.onSize, this), height: this.props.height, width: this.props.width }, height && width && (React__default.createElement(React.Fragment, null,
  ...
  class Map$1 extends React.Component {
      ...
      renderCountry(point, index, path) {
          ...
          return (React__default.createElement("path", { key: `path-${index}`, d: path(point), className: css$J.country }));
      }
      renderChart(containerProps) {
          ...
          return (React__default.createElement(framerMotion.motion.g, { initial: {
              ...
              markers &&
                  markers.map((marker, index) => (React__default.createElement(React.Fragment, { key: `marker-${index}` }, this.renderMarker(marker, index, projection))))));
      }
      render() {
          const { id, width, height, margins, className } = this.props;
          return (React__default.createElement(ChartContainer, { id: id, width: width, height: height, margins: margins, xAxisVisible: false, yAxisVisible: false, className: classNames(className) }, props => this.renderChart(props)));
      }
  }
  ...
  class MapMarker extends React.Component {
      ...
      render() {
          ...
          return (React__default.createElement(React.Fragment, null,
              ...
              tooltip && (React__default.createElement(Tooltip, { visible: !!active, reference: this.ref, modifiers: modifiers, content: tooltip }))));
      }
  }
  ...
  const MotionArc = (_a) => {
      ...
      const d = framerMotion.useMotionValue(custom.exit);
      const prevPath = framerMotion.useMotionValue(custom.exit);
      const spring = framerMotion.useSpring(prevPath, Object.assign(Object.assign({}, DEFAULT_TRANSITION), { from: 0, to: 1 }));
      React.useEffect(() => {
          const from = custom.previousEnter || prevPath.get();
          const interpolator = d3Interpolate.interpolate(from, custom.enter);
          const unsub = spring.onChange(v => d.set(arc(interpolator(v))));
          prevPath.set(custom.enter);
          return unsub;
      });
      const { d: enterD } = custom.enter;
      return (React__default.createElement(framerMotion.motion.path, Object.assign({}, rest, { transition: transition, d: transition.type !== false ? d : enterD })));
  };
  ...
  class PieArc extends React.Component {
      ...
      render() {
          ...
          return (React__default.createElement("g", { ref: this.arc },
              React__default.createElement(MotionArc, { style: { cursor }, fill: fill, arc: innerArc, custom: {
                      enter: data,
                      exit,
                      previousEnter
              ...
              tooltip && !tooltip.props.disabled && (React__default.createElement(CloneElement, { element: tooltip, visible: !!active, reference: this.arc, value: { y: data.data.data, x: data.data.key } }))));
      }
  }
  PieArc.defaultProps = {
      cursor: 'initial',
  ...
  class SankeyLabel extends React.Component {
      render() {
          ...
          return (visible &&
              node && (React__default.createElement("text", { className: classNames(css$N.label, className), x: showRightSide ? nodePositions.x1 + 6 : nodePositions.x0 - 6, y: (nodePositions.y1 + nodePositions.y0) / 2, dy: "0.35em", textAnchor: textAnchor, fill: fill, opacity: opacity(active), style: { padding } }, node.title)));
      }
  }
  ...
  class SankeyLink extends React.Component {
      ...
      renderLink() {
          ...
          return (React__default.createElement("g", { ref: this.link },
              React__default.createElement(framerMotion.motion.path, { key: `sankey-link-${enterProps.d}-${index}`, className: classNames(css$P.link, className), style: style, initial: exitProps, animate: enterProps, exit: exitProps, transition: {
                      duration: 0.5
      ...
      renderTooltipContent() {
          ...
          return (React__default.createElement("div", { className: css$P.tooltip },
              React__default.createElement("div", { className: css$P.tooltipLabel }, `${source.title} → ${target.title}`),
              React__default.createElement("div", { className: css$P.tooltipValue }, formatValue(value))));
      }
      render() {
  ...
  SankeyLink.defaultProps = {
      ...
      tooltip: (React__default.createElement(Tooltip, { followCursor: true, modifiers: {
              offset: {
                  offset: '0, 5px'
              }
          } })),
  ...
  class SankeyNode extends React.Component {
      ...
      renderNode() {
          ...
          return (React__default.createElement("g", { ref: this.rect },
              React__default.createElement(framerMotion.motion.rect, { key: `sankey-node-${x0}-${x1}-${y0}-${y1}-${index}`, className: classNames(css$R.node, className), fillOpacity: opacity(active, disabled), style: style, x: x0, y: y0, width: nodeWidth, height: nodeHeight, fill: color, initial: {
                      opacity: 0
                  }, animate: {
                      opacity: 1
                  }, exit: {
      ...
      renderTooltipContent() {
          ...
          return (React__default.createElement("div", { className: css$R.tooltip },
              React__default.createElement("div", { className: css$R.tooltipLabel }, title),
              React__default.createElement("div", { className: css$R.tooltipValue }, formatValue(value))));
      }
      render() {
  ...
  class RadialArea extends React.Component {
      getFill(color) {
  ...
  class RadialPointSeries extends React.Component {
      isVisible(point, index) {
          const { show, activeValues, data } = this.props;
          const isActive = activeValues && point && isEqual(activeValues.x, point.x);
          if (show === 'hover') {
      ...
      render() {
          ...
          return (React__default.createElement(RadialScatterSeries, { animated: animated, data: data, xScale: xScale, yScale: yScale, point: React__default.createElement(CloneElement, { element: point, color: color, tooltip: null, visible: this.isVisible.bind(this) }) }));
      }
  }
  ...
  class RadialAreaChart extends React.Component {
      constructor() {
          super(...arguments);
          this.getScales = memoize((preData, outerRadius, innerRadius) => {
              const data = buildShallowChartData(preData);
      ...
      renderChart(containerProps) {
          ...
          return (React__default.createElement(React.Fragment, null,
              axis && (React__default.createElement(CloneElement, { element: axis, xScale: xScale, height: chartHeight, width: chartWidth, innerRadius: innerRadius })),
              React__default.createElement(CloneElement, { element: series, id: id, data: data, xScale: xScale, yScale: yScale, height: chartHeight, width: chartWidth, outerRadius: outerRadius, innerRadius: innerRadius })));
      }
      render() {
          const { id, width, height, margins, className } = this.props;
          return (React__default.createElement(ChartContainer, { id: id, width: width, height: height, margins: margins, xAxisVisible: false, yAxisVisible: false, center: true, className: className }, this.renderChart.bind(this)));
  ...
  class RadialGaugeLabel extends React.PureComponent {
      render() {
          ...
          return (React__default.createElement("text", { dy: "1.23em", x: "0", y: offset, textAnchor: "middle", onClick: nativeEvent => onClick({ data, nativeEvent }), className: classNames(className, css$V.valueLabel) }, label));
      }
  }
  ...
  class RadialGaugeValueLabel extends React.PureComponent {
      render() {
          ...
          return (React__default.createElement(CountUp, { start: 0, end: data.data, delay: 0, duration: 1, separator: "," }, ({ countUpRef }) => (React__default.createElement("text", { dy: "-0.5em", x: "0", y: "15", textAnchor: "middle", className: classNames(className, css$X.valueLabel), ref: countUpRef }))));
      }
  }
  ...
  class HeatmapCell extends React.Component {
      ...
      render() {
          ...
          const transition = this.getTransition();
          return (React__default.createElement(React.Fragment, null,
              React__default.createElement("g", { ref: this.rect },
                  React__default.createElement(framerMotion.motion.rect, Object.assign({}, rest, { fill: fill, stroke: stroke, style: Object.assign(Object.assign({}, extras.style), { cursor }), className: classNames(css$Z.cell, extras.className), initial: {
                          opacity: 0
                      }, animate: {
                          opacity: 1
                      }, exit: {
  ...
  const LinearGaugeOuterBar = (_a) => {
      ...
      return React__default.createElement("rect", Object.assign({}, rest, { fill: fill || '#484848', width: width, height: height }));
  };
